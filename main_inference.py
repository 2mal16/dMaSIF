...
if args.single_pdb != "":
    ...
    single_data_dir = Path("./data_preprocessing/npys/")
    print(pdb_list)
    pdb_list = [pdb for pdb in pdb_list if Path(single_data_dir / f"{pdb.split("_")[0]}{pdb.split("_")[1]}_atomxyz.npy").exists() and Path(single_data_dir / f"{pdb.split("_")[0]}{pdb.split("_")[2]}_atomxyz.npy").exists()]
    print(pdb_list)
